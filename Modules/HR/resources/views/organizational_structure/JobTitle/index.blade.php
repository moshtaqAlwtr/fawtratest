    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">ادراة المسمى الوظيفي</h2>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        <div></div>
                        <div>
                            <a href="{{ route('JobTitles.create') }}" class="btn btn-outline-primary">
                                <i class="fa fa-plus me-2"></i> اضافة مسمى وظيفي
                            </a>
                        </div>
                    </div>
                </div>
                        ...
                        <form class="form">
                            <div class="form-body row">
                                <div class="form-group col-md-4">
                                    <label for="feedback2" class="sr-only"> مسمى وظيفي</label>
                                    <input type="email" id="feedback2" class="form-control"
                                        placeholder="البحث بواسطة مسمى وظيفي " name="email">
                                </div>
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton303">
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('JobTitles.show',$title->id) }}">
                                                                <i class="fa fa-eye me-2 text-primary"></i>عرض
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('JobTitles.edit',$title->id) }}">
                                                                <i class="fa fa-edit me-2 text-success"></i>تعديل
                                                            </a>
                                                        </li>

                                                        <li>
                                                            <a class="dropdown-item text-danger" href="#" data-toggle="modal" data-target="#modal_DELETE{{ $title->id }}">
