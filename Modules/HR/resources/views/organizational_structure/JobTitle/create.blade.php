...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">اضافة مسمى وظيفي</h2>
    ...
    <div class="content-body">
        <div class="container-fluid">
            <form class="form-horizontal" action="{{ route('JobTitles.store') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="form-body row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <textarea id="feedback2" class="form-control" rows="2" placeholder="الوصف" name="description">{{ old('description') }}</textarea>
                                </div>
