    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">اضافة قسم</h2>
                            ...
                            <form class="form">
                                <div class="form-body row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" id="feedback2" class="form-control" name="name" value="{{ old('name') }}">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label> الاختصار </label>
                                        <input type="text" id="feedback2" class="form-control" name="short_name" value="{{ old('short_name') }}">
                                    </div>
