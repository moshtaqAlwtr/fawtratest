...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">تعديل  قالب الراتب</h2>
    ...
    <div class="content-body">
        <form class="form" action="{{ route('SalaryTemplates.update', $salaryTemplates->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            @if ($errors->any())
