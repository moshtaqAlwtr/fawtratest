...
@section('title', 'تعديل قواعد الحضور')
    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">تعديل قواعد الحضور</h2>
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <div>
                    ...
                    <button type="submit" form="editForm" class="btn btn-outline-primary">
    ...
    <div class="cart mt-5">
        <div class="card">
            <div class="card-header text-center">
                <h4>تعديل قاعدة الحضور: {{ $attendanceRule->name }}</h4>
            </div>
            <div class="card-body">
                <form id="editForm" action="{{ route('attendance-rules.update', $attendanceRule->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text"
                                   ...
                                   id="name"
                                   name="name"
                                   value="{{ old('name', $attendanceRule->name) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-center">
                                <input type="color"
                                       ...
                                       id="color"
                                       name="color"
                                       value="{{ old('color', $attendanceRule->color) }}"
                                       title="اختر اللون"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control select2 @error('status') is-invalid @enderror"
                                    ...
                                    name="status"
                                    required>
                                <option value="active" {{ old('status', $attendanceRule->status) == 'active' ? 'selected' : '' }}>نشط</option>
                                <option value="inactive" {{ old('status', $attendanceRule->status) == 'inactive' ? 'selected' : '' }}>غير نشط</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            ...
                            <select class="form-control select2 @error('shift_id') is-invalid @enderror"
                                ...
                                @foreach ($shifts as $shift)
                                    <option value="{{ $shift->id }}"
                                            {{ old('shift_id', $attendanceRule->shift_id) == $shift->id ? 'selected' : '' }}>
                                        {{ $shift->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      ...
                                      name="description"
                                      rows="3"
                                      placeholder="أدخل الوصف">{{ old('description', $attendanceRule->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                       ...
                                       id="formula"
                                       name="formula"
                                       value="{{ old('formula', $attendanceRule->formula) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                       ...
                                       id="condition"
                                       name="condition"
                                       value="{{ old('condition', $attendanceRule->condition) }}"
...
$(document).ready(function() {
    ...
    $('#editForm').on('submit', function(e) {
        ...
        Swal.fire({
            title: 'هل أنت متأكد؟',
            text: 'سيتم تحديث بيانات قاعدة الحضور',
            icon: 'question',
