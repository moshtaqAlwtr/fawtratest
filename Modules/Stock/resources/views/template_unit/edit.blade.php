...
@section('content')
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">تعديل قالب الوحدة</h2>
    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <form class="form-horizontal" action="{{ route('template_unit.update', $templateUnit->id) }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <h4 class="card-title">تعديل قالب الوحدة</h4>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="form-body row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="datetime" class="form-control" name="base_unit_name" placeholder="مثال : جرام" value="{{ old('base_unit_name', $templateUnit->base_unit_name) }}">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="">التمييز</label>
                                    <input type="text" id="datetime" class="form-control" name="discrimination" placeholder="مثال : جم" value="{{ old('discrimination', $templateUnit->discrimination) }}">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="">القالب</label>
                                    <input type="text" id="datetime" class="form-control" name="template" placeholder="مثال : الوزن" value="{{ old('template', $templateUnit->template) }}">
                                </div>

                                <div class="form-group col-md-2 mt-2">
                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                        <input type="checkbox" name="status" value="1" {{ $templateUnit->status ? 'checked' : '' }}>
                                ...
                                <div class="form-group col-md-12">
                                    <table class="table table-striped" id="itemsTable">
                                        ...
                                        <tbody>
                                            @foreach ($templateUnit->sub_units as $unit)
                                                <tr>
                                                    <td><input type="text" name="larger_unit_name[]" class="form-control larger_unit_name" placeholder="مثال : كيلوجرام" value="{{ old('larger_unit_name', $unit->larger_unit_name) }}"></td>
                                                    <td><span class="conversion-text">1 {{ $unit->larger_unit_name }} يساوي</span></td>
                                                    <td><input type="number" name="conversion_factor[]" class="form-control conversion_factor" placeholder="مثال : 1000" value="{{ old('conversion_factor', $unit->conversion_factor) }}"></td>
                                                    <td><input type="text" name="sub_discrimination[]" class="form-control sub_discrimination" placeholder="مثال : كجم" value="{{ old('sub_discrimination', $unit->sub_discrimination) }}"></td>
                                                    <td>
