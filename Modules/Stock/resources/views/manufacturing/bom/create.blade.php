...
@section('content')
            ...
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">
                        <i class="fas fa-industry me-2"></i>قوائم مواد الإنتاج
                    </h2>
    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <form class="form-horizontal" action="{{ route('Bom.store') }}" method="POST" enctype="multipart/form-data" id="bomForm">
                @csrf
                ...
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <h4 class="card-title">
                                <i class="fas fa-info-circle me-2"></i>معلومات قائمة مواد الإنتاج
                            </h4>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row g-4">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="code" value="{{ $serial_number }}" required>
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <p onclick="toggleSection('rawMaterials')" class="d-flex justify-content-between section-header">
                                        <span class="p-1 font-weight-bold">
                                            <i class="feather icon-package me-2"></i> المواد الخام (<span id="rawMaterialCount">0</span>)
                                        </span>
                                ...
                                <div class="form-group col-md-12">
                                    <p onclick="toggleSection('expenses')" class="d-flex justify-content-between section-header">
                                        <span class="p-1 font-weight-bold">
                                            <i class="fa fa-money me-2"></i> المصروفات (<span id="rowExpensesCount">0</span>)
                                        </span>
                                        <i class="feather icon-plus-circle p-1"></i>
                                    </p>
                                ...
                                <div class="form-group col-md-12">
                                    <p onclick="toggleSection('manufacturing')" class="d-flex justify-content-between section-header">
                                        <span class="p-1 font-weight-bold">
                                            <i class="feather icon-settings me-2"></i> عمليات التصنيع (<span id="manufacturingCount">0</span>)
                                        </span>
                                        <i class="feather icon-plus-circle p-1"></i>
                                    </p>
                                ...
                                <div class="form-group col-md-12">
                                    <p onclick="toggleSection('endLife')" class="d-flex justify-content-between section-header">
                                        <span class="p-1 font-weight-bold">
                                            <i class="feather icon-trash-2 me-2"></i> المواد الهالكة (<span id="EndLifeCount">0</span>)
                                        </span>
                                        <i class="feather icon-plus-circle p-1"></i>
                                    </p>
...
<script>
    ...
    document.getElementById('bomForm').addEventListener('submit', function(e) {
        ...
        Swal.fire({
            title: 'تأكيد الحفظ',
            text: 'هل أنت متأكد من حفظ قائمة مواد الإنتاج؟',
            icon: 'question',
  ...
  function updateTotalCost() {
    ...
    // Subtract end life total (هذا هو التغيير الرئيسي)
    const endLifeTotal = parseFloat(document.querySelector('.end-life-grand-total').textContent) || 0;
    totalCost -= endLifeTotal; // طرح بدلاً من الجمع
