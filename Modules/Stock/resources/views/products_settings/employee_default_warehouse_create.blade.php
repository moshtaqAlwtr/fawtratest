...
@section('content')
    ...
    <div class="content-body">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-vertical" action="{{ route('inventory_settings.employee_default_warehouse_store') }}" method="POST">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="basicSelect" name="storehouse_id">
                                        ...
                                        @foreach($warehouses as $warehouse)
                                            <option value="{{ $warehouse->id }}" {{ old('storehouse_id') == $warehouse->id ? 'selected' : '' }}>{{ $warehouse->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
