        ...
        <div class="receipt-container">
            <div class="receipt">
                ...
                <div class="receipt-header">
                    <h1 class="receipt-title">فاتورة ضريبية مبسطة</h1>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            @foreach ($invoice->items as $index => $item)
                               @php
    $unit_price = $item->unit_price; // السعر قبل الضريبة
    $quantity = $item->quantity;
    $subtotal = $unit_price * $quantity; // المجموع قبل الضريبة
    $discount = $item->discount ?? 0;
    $net = $subtotal - $discount;
    $tax = $item->tax_1; // الضريبة المحفوظة
@endphp
                                <tr>
                                    <td>{{ $index + 1 }}</td>
