                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">تعديل حساب
                            </li>
                        </ol>
                    </div>
                </div>
    ...
    <div class="content-body">
        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <form id="products_form" class="form form-vertical" action="{{ route('treasury.update_account_bank',$treasury->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email-id-vertical" class="form-control"name="name" value="{{ old('name',$treasury->name) }}">
                                        @error('name')
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email-id-vertical" class="form-control"name="bank_name" value="{{ old('bank_name',$treasury->bank_name) }}">
                                        @error('bank_name')
                                        <span class="text-danger" id="basic-default-name-error" class="error">
                                            {{ $message }}
                                        </span>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="email-id-vertical" class="form-control"name="account_number" value="{{ old('account_number',$treasury->account_number) }}">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="basicSelect" name="currency">
                                            <option value="0" {{ old('currency',$treasury->currency) == 0 ? 'selected' : '' }}>ريال</option>
                                            <option value="1" {{ old('currency',$treasury->currency) == 1 ? 'selected' : '' }}>جنية</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="basicSelect" name="status">
                                            <option value="0" {{ old('status',$treasury->status) == 0 ? 'selected' : '' }}>نشط</option>
                                            <option value="1" {{ old('status',$treasury->status) == 1 ? 'selected' : '' }}>غير نشط</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control" id="basicTextarea" rows="2">{{ old('description',$treasury->description) }}</textarea>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="deposit_permissions" name="deposit_permissions">
                                                    ...
                                                    <option value="1" {{ old('deposit_permissions',$treasury->deposit_permissions) == 1 ? 'selected' : '' }}>موظف محدد</option>
                                                    <option value="2" {{ old('deposit_permissions',$treasury->deposit_permissions) == 2 ? 'selected' : '' }}>دور وظيفي محدد</option>
                                                    <option value="3" {{ old('deposit_permissions',$treasury->deposit_permissions) == 3 ? 'selected' : '' }}>فرع محدد</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="withdraw_permissions" name="withdraw_permissions">
                                                    ...
                                                    <option value="1" {{ old('withdraw_permissions',$treasury->withdraw_permissions) == 1 ? 'selected' : '' }}>موظف محدد</option>
                                                    <option value="2" {{ old('withdraw_permissions',$treasury->withdraw_permissions) == 2 ? 'selected' : '' }}>دور وظيفي محدد</option>
                                                    <option value="3" {{ old('withdraw_permissions',$treasury->withdraw_permissions) == 3 ? 'selected' : '' }}>فرع محدد</option>
                                                </select>
                                            </div>
                                        </div>
