...
@section('content')
    ...
    <div class="content-body">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                    <div>
                        <strong>مصروف</strong> | <small>{{ $expense->code }} #</small> | <span
        ...
        <div class="container" style="max-width: 1200px">
            <div class="card">
                <div class="card-title p-2">
                    <a href="{{ route('expenses.edit', $expense->id) }}" class="btn btn-outline-primary btn-sm">تعديل <i
                            class="fa fa-edit"></i></a>
                    <a href="#" class="btn btn-outline-danger btn-sm" data-toggle="modal"
                        data-target="#modal_DELETE{{ $expense->id }}">حذف <i class="fa fa-trash"></i></a>
        ...
        <!-- Modal delete -->
        <div class="modal fade text-left" id="modal_DELETE{{ $expense->id }}" tabindex="-1" role="dialog"
