...
@section('content')
                ...
                <div class="col-12">
                    ...
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">استلم شيك
                            </li>
                        </ol>
                    </div>
                </div>
    ...
    <div class="content-body">
        <div class="container-fluid">
            <form class="form-horizontal" action="{{ route('received_cheques.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="form-body row">
                                ...
                                <div class="form-group col-md-12">
                                    <div class="vs-checkbox-con vs-checkbox-primary">
                                        <input type="checkbox" value="1" name="endorsement"  id="checkboxToggle" {{ old('endorsement') == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control select2" id="basicSelect" name="collection_account_id">
                                        ...
                                        <option value="1" {{ old('collection_account_id') == 1 ? 'selected' : '' }}>حساب شخصي</option>
                                        <option value="2" {{ old('collection_account_id') == 2 ? 'selected' : '' }}>حساب شركة</option>
                                        <option value="3" {{ old('collection_account_id') == 3 ? 'selected' : '' }}>حساب مؤسسة</option>
                                    </select>
                                </div>
