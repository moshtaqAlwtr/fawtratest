    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">الشيكات المدفوعه</h2>
                ...
                <div class="card-body">
                    <div class="card-title">
                        <div class="d-flex justify-content-between align-items-center flex-wrap">
                            <div>بحث </div>
                            <div>
                                <a href="{{ route('check_books.index') }}" class="btn btn-outline-success">
                                    <i class="fa fa-cog me-2"></i>اداره دفاتر الشيكات
                                </a>
                                <a href="{{ route('payable_cheques.create') }}" class="btn btn-outline-primary">
                                    <i class="fa fa-plus me-2"></i>إصدار شيك
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card-content">
                <div class="card-body">
                    <div class="table-responsive">
                        @if(isset($payable_cheques) && !@empty($payable_cheques) && $payable_cheques->count() > 0)
                            <table class="table table-striped" dir="rtl">
                                <thead class="table-light">
                                    <tr>
                                        <th scope="col">شيك #</th>
                                        <th scope="col">دفتر الشيكات #</th>
                                ...
                                <tbody>
                                    @foreach ($payable_cheques as $cheque)
                                        <tr>
                                            <td>{{ $cheque->cheque_number }}</td>
                                            <td>{{ $cheque->cheque_book->cheque_book_number }}</td>
                                                ...
                                                <div class="btn-group">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton303">
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('payable_cheques.show', $cheque->id) }}">
                                                                    <i class="fa fa-eye me-2 text-primary"></i>عرض
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item" href="{{ route('payable_cheques.edit', $cheque->id) }}">
