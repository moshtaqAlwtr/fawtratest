...
@section('css')
    ...
    <style>
        ...
        .select2-selection__arrow {
         ...
         /* Badge styles for endorsement types */
         .endorsement-badge {
                ...
                <div class="col-md-8">
                    ...
                    <nav class="breadcrumb-custom">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active">تقرير الشيكات المستلمة</li>
                        </ol>
                    </nav>
                </div>
                ...
                <form id="reportForm">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <label class="form-label-modern"><i class="fas fa-user-circle me-2"></i>الحساب المستلم</label>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <label class="form-label-modern"><i class="fas fa-piggy-bank me-2"></i>حساب التحصيل</label>
                            <select name="collection_account" id="collection_account" class="form-control select2">
                                <option value="">جميع حسابات التحصيل</option>
                                @foreach ($collection_accounts as $account)
                                    <option value="{{ $account->id }}">{{ $account->name }} - {{ $account->code ?? '' }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <label class="form-label-modern"><i class="fas fa-stamp me-2"></i>نوع التظهير</label>
                            <select name="endorsement" id="endorsement" class="form-control select2">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <label class="form-label-modern"><i class="fas fa-user-tag me-2"></i>المدفوع له</label>
                            <input type="text" name="payee_name" id="payee_name" class="form-control" placeholder="اسم المدفوع له">
                        </div>

                        <div class="col-lg-3 col-md-6">
                            <label class="form-label-modern"><i class="fas fa-id-card me-2"></i>الاسم</label>
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <select name="group_by" id="group_by" class="form-control select2">
                                ...
                                <option value="recipient_account">الحساب المستلم</option>
                                <option value="collection_account">حساب التحصيل</option>
                                <option value="endorsement">نوع التظهير</option>
        ...
        <div class="row mb-4 fade-in" id="totalsSection">
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="stats-card warning">
                    ...
                    <div class="stats-label">الشيكات المتأخرة</div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="stats-card info">
                    ...
                    <div class="stats-value" id="dueTodayCount">0</div>
                    <div class="stats-label">تستحق اليوم</div>
                </div>
            </div>
        </div>
        ...
        <div class="card-modern fade-in mb-4" id="chartSection">
            <div class="card-header-modern">
                <h5 class="mb-0">
                    ...
                    الرسم البياني للشيكات المستلمة
                </h5>
            </div>
            <div class="card-body-modern">
                <div class="row">
                    ...
                    <table class="table table-modern mb-0">
                        <thead>
                            <tr>
                                ...
                                <th><i class="fas fa-user-tag me-2"></i>المدفوع له</th>
                                <th><i class="fas fa-id-card me-2"></i>الاسم</th>
                                <th><i class="fas fa-user-circle me-2"></i>الحساب المستلم</th>
                                <th><i class="fas fa-piggy-bank me-2"></i>حساب التحصيل</th>
                                <th><i class="fas fa-calendar-alt me-2"></i>تاريخ الإصدار</th>
                                <th><i class="fas fa-calendar-check me-2"></i>تاريخ الاستحقاق</th>
                                <th><i class="fas fa-stamp me-2"></i>نوع التظهير</th>
                                <th><i class="fas fa-paperclip me-2"></i>مرفق</th>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function loadReportData() {
                ...
                $.ajax({
                    url: '{{ route('checksReports.receivedChequesReportAjax') }}',
                    method: 'GET',
                    data: formData,
            ...
            function updateReportDisplay(data) {
                ...
                animateValue('#overdueCount', 0, data.totals.overdue_count, 1000);
                animateValue('#dueTodayCount', 0, data.totals.due_today_count, 1000);

                // تحديث عنوان التقرير
                $('#reportTitle').html(`
                    <i class="fas fa-table me-2"></i>
                    تقرير الشيكات المستلمة من ${data.from_date} إلى ${data.to_date}
                `);
                ...
                statusChart = new Chart(statusCtx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'توزيع الشيكات حسب حالة الاستحقاق',
                                font: {
                                    family: 'Cairo',
                                    size: 14,
                                    weight: 'bold'
                ...
                amountChart = new Chart(amountCtx, {
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: 'توزيع المبالغ حسب الحساب المستلم',
                                font: {
                                    family: 'Cairo',
                                    size: 14,
                                    weight: 'bold'
                    ...
                    tableHtml = `
                        <tr>
                            <td colspan="12" class="text-center py-5">
                                ...
                                <p class="text-muted">لا توجد شيكات مستلمة تطابق المعايير المحددة</p>
                            </td>
                        </tr>
                    `;
                } else {
                    cheques.forEach((cheque, index) => {
                        const endorsementInfo = getEndorsementInfo(cheque.endorsement);
                        ...
                        tableHtml += `
                            <tr class="cheque-row">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-muted">شيك مستلم</small>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <small class="text-muted">المدفوع له</small>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <span class="badge bg-primary-subtle text-primary">
                                        ...
                                        ${cheque.name || 'غير محدد'}
                                    </span>
                                </td>
                                <td>
                                    <span class="badge bg-secondary-subtle text-secondary">
                                        <i class="fas fa-user-circle me-1"></i>
                                        ${cheque.recipient_account ? cheque.recipient_account.name : 'غير محدد'}
                                    </span>
                                </td>
                                <td>
                                    <span class="badge bg-info-subtle text-info">
                                        <i class="fas fa-piggy-bank me-1"></i>
                                        ${cheque.collection_account ? cheque.collection_account.name : 'غير محدد'}
                                    </span>
                                </td>
                                ...
                                <td>
                                    <span class="endorsement-badge ${endorsementInfo.class}">
                                        <i class="${endorsementInfo.icon} me-1"></i>
                                        ${endorsementInfo.text}
                                    </span>
                                </td>
                                <td class="text-center">
                                    ${cheque.attachment ?
                                        '<span class="attachment-badge"><i class="fas fa-paperclip me-1"></i>مرفق</span>' :
            ...
            // دالة الحصول على معلومات نوع التظهير
            function getEndorsementInfo(endorsement) {
                const endorsementMap = {
                    'cash': {
                        class: 'endorsement-cash',
                        icon: 'fas fa-money-bill-wave',
                        text: 'نقدي'
                    },
                    'bank_deposit': {
                        class: 'endorsement-bank',
                        icon: 'fas fa-university',
                        text: 'إيداع بنكي'
                    },
                    'transfer': {
                        class: 'endorsement-transfer',
                        icon: 'fas fa-exchange-alt',
                        text: 'تحويل'
                    },
                    'other': {
                        class: 'endorsement-other',
                        icon: 'fas fa-ellipsis-h',
                        text: 'أخرى'
                    }
                };

                return endorsementMap[endorsement] || {
                    class: 'endorsement-other',
            ...
            function exportToExcel() {
                ...
                const today = new Date();
                const fileName = `تقرير_الشيكات_المستلمة_${today.getFullYear()}-${String(today.getMonth() + 1).padStart(2, '0')}-${String(today.getDate()).padStart(2, '0')}.xlsx`;
            ...
            function exportToPdf() {
                ...
                // إضافة العنوان
                doc.setFontSize(16);
                doc.text('تقرير الشيكات المستلمة', 20, 20);
                ...
                // حفظ الملف
                const fileName = `تقرير_الشيكات_المستلمة_${today.replace(/\//g, '-')}.pdf`;
                doc.save(fileName);
