        ...
        <div class="col-md-6">
            <nav aria-label="Pagination Navigation">
                <ul class="pagination pagination-sm mb-0 justify-content-start">
                    ...
                    @else
                        <li class="page-item">
                            <a class="page-link" href="#" data-page="{{ $items->currentPage() - 1 }}">السابق</a>
                        </li>
                    @endif
                    ...
                    @if($items->currentPage() < $items->lastPage() - 2)
                        ...
                        @endif
                        <li class="page-item">
                            <a class="page-link" href="#" data-page="{{ $items->lastPage() }}">{{ $items->lastPage() }}</a>
                        </li>
                    @endif
                    ...
                    @if ($items->hasMorePages())
                        <li class="page-item">
                            <a class="page-link" href="#" data-page="{{ $items->currentPage() + 1 }}">التالي</a>
                        </li>
                    @else
                        <li class="page-item disabled">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (gotoPageBtn && gotoPageInput) {
        gotoPageBtn.addEventListener('click', function() {
            ...
            if (page >= 1 && page <= maxPage && page !== {{ $items->currentPage() }}) {
