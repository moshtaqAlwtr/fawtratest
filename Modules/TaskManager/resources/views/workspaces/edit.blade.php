    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">تعديل مساحة العمل</h2>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" class="form-control" value="{{ old('title', $workspace->title) }}" placeholder="أدخل اسم مساحة العمل" required>
                                            <small class="form-text text-muted">مثال: قسم التطوير، فريق التسويق، المشاريع الخاصة</small>
                                        </div>

                                        <div class="form-group">
                                            <label>وصف مساحة العمل</label>
                                            <textarea name="description" class="form-control" rows="4" placeholder="وصف تفصيلي لمساحة العمل والغرض منها...">{{ old('description', $workspace->description) }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name="is_primary" id="is_primary" value="1" {{ old('is_primary', $workspace->is_primary) ? 'checked' : '' }}>
...
$(document).ready(function() {
    ...
    $('#workspace-form').on('submit', function(e) {
        ...
        .fail(function(xhr) {
            let errorMessage = 'حدث خطأ أثناء تحديث مساحة العمل';
        ...
        .always(function() {
            submitBtn.prop('disabled', false).html('<i class="feather icon-save"></i> حفظ التعديلات');
        });
    });
