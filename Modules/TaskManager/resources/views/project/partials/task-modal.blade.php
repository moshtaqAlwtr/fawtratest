...
@section('content')
    @include('taskmanager::task.partial.task-modal')
                    ...
                    <div class="card-header">
                        ...
                        <div class="heading-elements">
                            <button type="button" class="btn btn-primary btn-sm"
                                onclick="openTaskModalForProject({{ $project->id }})">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                    <h4 class="modal-title text-white" id="task-modal-title">إضافة مهمة جديدة</h4>
                ...
                <div class="modal-body">
                    <form id="task-form" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="task-title">عنوان المهمة <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="task-description" name="description" rows="3" maxlength="5000"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="task-status">الحالة <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="task-priority">الأولوية <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="task-budget">الميزانية (ريال)</label>
                                    <input type="number" class="form-control" id="task-budget" name="budget"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="task-estimated-hours">الساعات المقدرة</label>
                                    <input type="number" class="form-control" id="task-estimated-hours"
                                        name="estimated_hours" min="0" max="9999" step="0.5">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="task-completion">نسبة الإنجاز: <span
                                            id="completion-value">0</span>%</label>
                                    <input type="range" class="custom-range" id="task-completion"
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="task-assigned-users">الموظفين المكلفين</label>
                                    <select class="form-control select2" id="task-assigned-users" name="assigned_users[]"
                                        multiple>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="task-files">إرفاق ملفات</label>
                                    <input type="file" class="form-control-file" id="task-files" name="files[]"
                                        multiple accept=".pdf,.doc,.docx,.xls,.xlsx,.jpg,.jpeg,.png,.gif">
                                    <small class="form-text text-muted">الحد الأقصى: 10 ميجابايت لكل ملف</small>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="custom-control custom-checkbox mb-2">
                                    <input type="checkbox" class="custom-control-input" id="task-is-urgent"
                                        name="is_urgent">
                                    <label class="custom-control-label" for="task-is-urgent">مهمة عاجلة</label>
                                </div>
                                                          </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="saveTask()">
                        <i class="feather icon-save"></i> حفظ المهمة
                    </button>
                </div>
            </div>
        </div>
    ...
    <script>
            ...
            $.get(`/projects/api/${projectId}/users`)
                .done(function(response) {
                    if (response.success && response.data) {
                        ...
                        // إعادة تهيئة Select2 إذا كان موجوداً
                        if ($.fn.select2) {
        ...
        $('#task-modal').on('hidden.bs.modal', function() {
            $('#task-form')[0].reset();
            $('#task-assigned-users').html('').trigger('change');
        });
    </script>
    ...
    <style>
        ...
        #task-modal .custom-range::-webkit-slider-thumb {
            background: #007bff;
        }

        #task-modal .custom-range::-moz-range-thumb {
            background: #007bff;
        }

        #task-modal .select2-container {
            width: 100% !important;
        }
    </style>
@endsection
