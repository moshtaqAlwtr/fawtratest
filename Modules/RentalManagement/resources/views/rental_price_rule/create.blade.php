...
@section('content')
    ...
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-left mb-0">أضافة قواعد التسعير </h2>
    ...
    <form   action="{{ route('rental_management.rental_price_rule.store') }}" method="POST" id="products_form" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="card mt-5">
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                                <label for="pricingName" class="form-label">اسم قاعدة
                                                    التسعير <span class="text-danger">*</span></label>
                                                <input type="text" id="pricingName" name="pricingName"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="form-check">
                                                        ...
                                                        <label for="inactive" class="form-check-label">غير
                                                            نشط</label>
                                                    </div>
                                                </div>
                                            </div>
