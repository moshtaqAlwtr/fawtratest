...
class LeaveRequest extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['employee_id', 'request_type', 'leave_type_id', 'start_date', 'end_date', 'days', 'description', 'status', 'approved_by', 'approved_at', 'rejection_reason', 'attachments'];
