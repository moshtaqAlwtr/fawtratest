...
class StoreHouse extends Model
{
    ...
    protected $fillable = ['id', 'name', 'shipping_address','storehouse_id', 'status', 'major', 'view_permissions', 'edit_stock_permissions', 'crate_invoices_permissions','value_of_view_permissions', 'value_of_edit_stock_permissions', 'value_of_crate_invoices_permissions', 'created_at', 'updated_at'];
